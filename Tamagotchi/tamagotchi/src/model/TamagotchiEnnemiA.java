...
public class TamagotchiEnnemiA extends Tamagotchi {

	public TamagotchiEnnemiA(String nom, int energy, int force, int joie, int faim, int fatigue, int propreté,
	...
	public String toString() {
		return "TamagotchiEnnemiA [Nom=" + Nom + ", Energy=" + Energy + ", Force=" + Force + ", Joie=" + Joie
